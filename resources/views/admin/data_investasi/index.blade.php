            ...
            <div class="col-sm-4 mb-3">
                <div class="card h-100">
                    <div class="card-header">
                        <h5 class="card-title">Data Investasi Tahun {{ $data->tahun }}</h5>
                    </div>
                    <div class="card-body">
                        <p><strong>Periode:</strong> {{ $data->periode }}</p>
                        <p><strong>Status Modal:</strong> {{ $data->status_penanaman_modal ?? '-' }}</p>
                        ...
                        <p><strong>Investasi Rp:</strong> 
                           {{ isset($data->investasi_rp_juta) ? number_format($data->investasi_rp_juta, 0, ',', '.') : '-' }}
                        </p>
                        <p><strong>Investasi US$:</strong> 
                           {{ isset($data->investasi_us_ribu) ? number_format($data->investasi_us_ribu, 0, ',', '.') : '-' }}
                        </p>
