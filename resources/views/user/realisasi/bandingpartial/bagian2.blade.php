<div class="card shadow-sm p-4">
    ...
    {{-- ======================= FILTER ======================== --}}
    <form id="filterBagian2" class="filter-bar row g-3 justify-content-center mb-4"
    ...
    @if($dataPerbandinganPeriode->isNotEmpty())
        ...
        <script>
            (function () {
                const ctx = document.getElementById('chartInvestasiPeriode').getContext('2d');
                if (window.chartPeriodeInstance) window.chartPeriodeInstance.destroy();
                window.chartPeriodeInstance = new Chart(ctx, {
                    type: 'bar',
                    data: {
...
document.addEventListener("DOMContentLoaded", function(){
    const form = document.querySelector("#filterBagian2");
    if(form){
        form.addEventListener("submit", function(e){
            e.preventDefault();
            const targetDiv = document.querySelector("#bagian2");
            targetDiv.innerHTML = `
